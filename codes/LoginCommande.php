      ...
      <main class="container">
          ...
          <div class="row">
              ...
              <div class='design col-lg-10' style=' margin-left : 0%;'> 
                <form method='post' action='LoginCommande.php' class=" formul col-lg-5 login-form" style='box-shadow : 0px 2px 3px black'>
                  <fieldset>
            ...
            <?php
              ...
              $requete = 'select * from produit p  where p.code like ? ';	// On recupere les biens qui ont des images dans la table `image`
              $stmtprod = $bdd -> prepare($requete);
              $stmtprod -> execute(array($_GET['code']));
                    ...
                    if(($t==1) and ($conf == 1) and ($verifnature == "client"))
                    {
                        if($stmtprod->execute())
                        {
                          ...
                          { $t++;
                            ...
                            $lien="productcommande.php?productname=".$row1['productname']."&code=".$row1['code'];
