      ...
      <main class="container">
          ...
          <div class="row">
              ...
              <div class='design col-lg-10' style=' margin-left : 0%;'> 
                <form method='post' action='LoginCommercant.php' class=" formul col-lg-5 login-form" style='box-shadow : 0px 2px 3px black'>
                  <fieldset>
                  ...
                  <br/><hr/><br/><span style='margin-left : 35%;;'><a href='InscriptionCommercant.php' class=' btn btn-success'>Creer un compte</a></span>
                </form>
            </div>
              ...
              if($_SERVER['REQUEST_METHOD'] == 'POST')
              {
                if(isset($_POST['email']) and isset($_POST['password']) ){
                  ...
                  if(!empty($email) and !empty($mdp)){
                    ...
                    if(($t==1) and ($conf == 1)and ($verifnature == "commerçant"))
                    {
