...
<div class="col-md-12 col-lg-12">
        ...
        <div class="row">
            ...
            <h4 class="mb-3">Inscription Client</h4>
                <form method='post' action='InscriptionClient.php' id='form' enctype='multipart/form-data'>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text"  class="form-control" name="nature"  readonly value="client">
                        </div>
